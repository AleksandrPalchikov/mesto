class FormValidator {
  ...
  _showInputError(inputElement, errorMessage) {
    ...
    ); //Why i cannot use herequerySelectorAll?
  ...
  _hideInputError(inputElement) {
    ...
    const errorElement = this.formElement.querySelector(
      `#${inputElement.id}-error`
    ); //Why i cannot use here querySelectorAll?
  ...
  _setEventListenersOnInputs() {
    ...
    const submitButtons = this.formElement.querySelector(
  ...
  popupFormReset() {
    ...
    const concreteInputsFormList = Array.from(
      this.formElement.querySelectorAll(this._inputSelector)
    );
    const concreteInputButton = this.formElement.querySelector(
      this._submitButtonSelector
    );
